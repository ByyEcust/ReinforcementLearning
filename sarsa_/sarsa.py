...
class SARSA(object):
    ...
    def train(self, state_no, action_no, reward, next_state_no, next_action_no, done, lr=1e-2):
        self.q_table[state_no, action_no] += lr * (reward + self.gamma * self.q_table[next_state_no, next_action_no] * float(1 - done)
